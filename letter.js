...
if (chosenWord === wordArray[0]) {
	var chromIncorrect = new IncorrectLetters(["a", "b", "d", "e", "f", "g", "i", "j", "k", "l", "n", "p", "q", "s", "t", "u", "v", "w", "x", "y", "z"]);
	...
	var morganIncorrect = new IncorrectLetters(["b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "p", "q", "s", "t", "u", "v", "w", "x", "y", "z"]);
	...
	var cordeliaIncorrect = new IncorrectLetters(["b", "f", "g", "h", "j", "k", "m", "n", "p", "q", "s", "t", "u", "v", "w", "x", "y", "z"]);
